<div class="container py-4">
    ...
    <div class="card border-0 bg-white rounded-4 shadow-sm p-4 mb-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <span class="text-uppercase text-muted fw-bold small" style="font-size: 0.75rem; letter-spacing: 0.5px;">My Balance</span>
                <h3 class="fw-bold mb-0 mt-1 d-flex align-items-center gap-3">
                    ...
                    <button class="btn btn-sm btn-light border-0 rounded-3 text-secondary" style="padding: 4px 8px;" wire:click="$toggle('showBalance')">
    ...
    <div class="row g-4">
                ...
                <div class="card pocket-card h-100 border-0 shadow-sm rounded-4 hover-card transition-all"
                    ...
                    <div class="card-body p-4 d-flex flex-column justify-content-between">
                        <div class="d-flex justify-content-between align-items-start">
                            <span class="bg-white bg-opacity-20 rounded-3 p-2 d-inline-flex align-items-center justify-content-center shadow-sm" style="width: 48px; height: 48px; font-size: 1.5rem;">
                                {{ $pocket->emoji }}
                            </span>
                            <span class="badge bg-white bg-opacity-20 text-uppercase fw-bold px-2 py-1" style="font-size: 0.65rem; letter-spacing: 0.5px; color: inherit;">
                                {{ $pocket->type }}
                            </span>
                        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <a {{-- href="{{ route('pocket.create') }}" --}} class="text-decoration-none h-100 d-block">
                <div class="card pocket-card h-100 border-0 shadow-sm bg-warning-subtle rounded-4 hover-card transition-all" style="min-height: 160px;">
